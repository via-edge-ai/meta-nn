...
class Demo:
  ...
  def build_pipeline(self, engine):
    ...
    cmd += f'queue ! tensor_decoder mode=bounding_boxes option1=mobilenet-ssd option2={self.label_path} option3={self.box_priors} option4={self.VIDEO_WIDTH}:{self.VIDEO_HEIGHT} option5={self.MODEL_INPUT_WIDTH}:{self.MODEL_INPUT_HEIGHT} ! '
    cmd += f'queue ! mix. '
