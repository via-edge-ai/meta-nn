...
class Demo:
  ...
  def build_pipeline(self, engine):
      ...
      cmd += f'tensor_decoder mode=pose_estimation option1={self.VIDEO_WIDTH}:{self.VIDEO_HEIGHT} option2={self.MODEL_INPUT_WIDTH}:{self.MODEL_INPUT_HEIGHT} option3={self.label_path} option4=heatmap-offset ! '
      cmd += f'mix. '
