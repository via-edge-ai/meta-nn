...
if __name__ == '__main__':
  ...
  if args.app == 'image_classification':
    ...
    os.system("python3 /usr/bin/nnstreamer-demo/nnstreamer_example_object_detection.py {0}".format(tmp_args))
  elif args.app == 'object_detection_yolov5':
    os.system("python3 /usr/bin/nnstreamer-demo/nnstreamer_example_object_detection_yolov5.py {0}".format(tmp_args))
  elif args.app == 'face_detection':
    os.system("python3 /usr/bin/nnstreamer-demo/nnstreamer_example_face_detection.py {0}".format(tmp_args))
