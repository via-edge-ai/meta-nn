...
SRCREV = "a75ae30ac3849a37ec39698dc046460d5ab9a1cd"
...
SRC_URI = "git://github.com/ARM-software/armnn.git;protocol=https;branch=${BRANCH_ARMNN} \
           ...
           file://0001-armnn-use-tensorflowlib-c-api.patch \
           "
...
RDEPENDS:${PN} += " arm-compute-library ${@bb.utils.contains('TFLITE_PREBUILT', '1', 'tensorflowlite-prebuilt', 'tensorflow-lite', d)} "
...
EXTRA_OECMAKE += " \
    ...
    -DBUILD_DELEGATE_JNI_INTERFACE=OFF \
